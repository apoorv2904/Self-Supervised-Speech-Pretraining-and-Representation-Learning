...
# SETTINGS #
############
DATA_TYPE = 'fbank' # this can be either ['mfcc', 'fbank', 'fmllr']
KALDI_ROOT = '/idiap/user/avyas/kaldi-july-2019/kaldi/' # change this to your own kaldi root
DATA_ROOT = '/idiap/user/avyas//idiap-repo/dev/pkwrap-e2e-egs/examples/farsi/data'
LIBRI_PATH = os.path.join(DATA_ROOT, DATA_TYPE + '_cmvn/') # this needs to be generated by the scripts `dump_fmllr_cmvn.sh` or `dump_mfcc_cmvn.sh`
OUTPUT_DIR = '../data/farsi_' + DATA_TYPE + '_cmvn' # 


############
# CONSTANT #
############
SETS = ['dev_set'] # you should not need to change this
...
def main():
    ...
    for s in SETS:
        with ReadHelper('ark:' + LIBRI_PATH + s + '_hires/' + DATA_TYPE + '_cmvn.ark') as reader:
    ...
    print('[ARK-TO-SWBD] - All done, saved at \'' + str(OUTPUT_DIR) + '\', exit.')
    exit()
